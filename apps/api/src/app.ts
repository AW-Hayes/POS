...
import { productClassesRouter } from './routes/product-classes';
import { finelinesRouter } from './routes/finelines';
...
app.use('/api/product-classes', productClassesRouter);
app.use('/api/finelines', finelinesRouter);
